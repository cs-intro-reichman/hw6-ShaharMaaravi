...
public class Runigram {
	...
	public static void main(String[] args) {
		...
		//Test the luumed version of an image: 
		// image = grayScaled(tinypic); 
		// System.out.println();
		// print(image);

		//Test scaled version of an image: 
	...
	private static Color luminance(Color pixel) {
		...
		Color lummed = new Color(lum, lum, lum); 
		return lummed;
	}
	...
	public static Color[][] scaled(Color[][] image, int width, int height) {
		...
		double rowRatio = (double) row / height; 
     	double colRatio = (double) col / width;

		for (int i = 0; i < height; i++) { 
			for (int j = 0; j < width; j++) { 
				int orgR = (int) (i*rowRatio); 
				int orgC = (int) (j*colRatio); 

				scaled[i][j] = image[orgR][orgC]; 
			}
		}
		return scaled;
	}
	...
	public static Color[][] blend(Color[][] image1, Color[][] image2, double alpha) {
		...
		Color [][] blended = new Color[row][col];
	...
	public static void morph(Color[][] source, Color[][] target, int n) {
		...
		int rowT = source.length; 
		int colT = source[0].length; 
		if(rowS != rowT || colS != colT) target = scaled(target, rowS, colS); 
